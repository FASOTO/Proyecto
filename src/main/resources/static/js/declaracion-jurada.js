...
document.getElementById('enfermedadNo').addEventListener('change', function() {
    document.getElementById('enfermedadTipoField').style.display = 'none';
});
...
document.getElementById('drogaAlergiaNo').addEventListener('change', function() {
    document.getElementById('drogaAlergiaTipoField').style.display = 'none';
});
...
document.getElementById('diabeticoNo').addEventListener('change', function() {
    document.getElementById('diabetesControlField').style.display = 'none';
});
...
/*---------------Aspirina o anticoagulante Frecuencia----------------*/
...
document.getElementById('chagasNo').addEventListener('change', function() {
    document.getElementById('chagasTratamientoField').style.display = 'none';
});
...
document.getElementById('epilepticoNo').addEventListener('change', function() {
    document.getElementById('epilepticoMedicacionField').style.display = 'none';
});

/*---------------Enfermedad Infecto tipo----------------*/
